---
layout: home
title: Getting Started with Terracotta Clustering
---
...
The only platform requirement is using JDK 17 or higher.
...
# On Windows:
start-tc-server.bat -auto-activate -cluster-name tc-cluster -offheap-resources=offheap-1:512MB,offheap-2:512MB

# On Unix / Mac:
./start-tc-server.sh -auto-activate -cluster-name tc-cluster -offheap-resources=offheap-1:512MB,offheap-2:512MB
```
